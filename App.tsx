...
const translations = {
  he: {
    ...
    pillar_1_desc: 'אנו מתמחים בפיתוח מערכות מורכבות לתעשיות ה-AI, הסייבר והביטחון, תוך בנייה ואימון של מודלי AI עצמאיים משלנו.',
    ...
    team_title: 'הצוות',
    team_roles: { founder: 'מייסד', ceo: 'CEO', cto: 'CTO', cmo: 'CMO', inst: 'מנהלת AI', comm: 'מנהל קהילה' },
    team_names: ['לי אור', 'יוסי אבני', 'שחר כהן', 'חווה זיגלמן'],
    ...
    hava_bio: 'בוגרת הטכניון ופרופסור אורחת לשעבר ב-MIT, הרווארד ומכון ויצמן, פרופ\' חווה זיגלמן היא חלוצה בעלת שם עולמי בבינה מלאכותית בהשראה ביולוגית ורשתות עצביות. כפרופסור (Provost Professor) באוניברסיטת UMass Amherst ומנהלת מעבדת BINDS, היא הגדירה מחדש את גבולות התחום באמצעות עבודתה פורצת הדרך על "היפר-חישוב" (hypercomputation) - חישוב מעבר לגבול טיורינג - והמצאתה המשותפת של אלגוריתם Support Vector Clustering. במהלך שירותה כמנהלת תוכנית ב-DARPA (2016–2019), היא חנכה את "הגל השלישי של הבינה המלאכותית" באמצעות תוכנית המערכות הלומדות לכל החיים (L2M) שלה, ויצרה מערכות המסוגלות להתפתח בזמן אמת. על מנהיגותה בעלת החזון, הוענקה לה מדליית השירות הציבורי המצטיין של DARPA, הכבוד האזרחי הגבוה ביותר שמוענק על ידי משרד ההגנה האמריקאי. כעמיתת IEEE ו-INNS, היא גם כלת פרס INNS Hebb ופרס יוזמת BRAIN של אובמה.',
    hava_subtitle: 'מנהלת AI, פרופסור באוניברסיטת מסצ׳וסטס וחוקרת AI בעלת שם עולמי',
    ...
    model_2: 'בית תוכנה',
    model_2_desc: 'בוגרות מקבלות מקום בבית התוכנה הייעודי שלנו, המעניק מעטפת פתרונות AI מותאמים אישית ושירותי תחזוקה.',
    ...
    biz_3: 'מודל חלוקת רווחים עתידיים',
    biz_3_desc: 'חלק מהרווחים העתידיים מיועדים להשקעה חוזרת ברווחתן ובחוסנן הכלכלי של עובדות בינתה, מתוך שאיפה לייצר עבורן תשתית יציבה המאפשרת צמיחה מקצועית ואישית.',
    ...
    timeline_steps: [
      {
        time: 'חודשים 0-2',
        title: 'תשתית וגיוס',
        desc: 'גיוס 12 מפתחות סיניוריות, הקמת תשתית LMS ותכנון פדגוגי.',
        pillars: {
          dev: 'גיבוש צוות פיתוח ראשוני של 12 סיניוריות. כתיבת שורות הקוד הראשונות.',
          acad: 'הקמת תשתית הלמידה, תכנון פדגוגי מפורט והכנה למחזור ראשון.',
          pr: 'ביסוס המותג והקו העיצובי, תכנון אסטרטגי של קמפיינים עתידיים.'
        }
      },
      {
        time: 'חודש 3',
        title: 'תחילת פעילות',
        desc: 'גיוס 50 סטודנטיות (מחזור 1), השקת קורסים ותחילת הכשרה.',
        pillars: {
          dev: 'השלמת מערכות הניהול והלמידה (AMS) עבור האקדמיה. תמיכה טכנית שוטפת.',
          acad: 'פתיחת מחזור 1 עם 50 סטודנטיות ותחילת הכשרה אינטנסיבית.',
          pr: 'השקה רשמית של המותג וחשיפה ראשונית של הקו העיצובי הייחודי.'
        }
      },
      {
        time: 'חודשים 4-6',
        title: 'צמיחה ופיתוח',
        desc: 'צמיחה ופיתוח, שילוב אופרטיבי בכתיבת קוד ופיתוח פרויקטי הליבה.',
        pillars: {
          ...
          pr: 'פרסום סיפורי הצלחה ראשונים ובניית אמינות בשוק הטכנולוגי.'
        }
      },
      {
        time: 'חודש 7',
        title: 'ייצור מעשי',
        desc: 'גיוס 60 סטודנטיות נוספות (מחזור 2), קליטת פרויקטים מורכבים.',
        pillars: {
          dev: 'שילוב התלמידות בהכשרות אינטנסיביות לצד צוותי הפיתוח המנוסים.',
          acad: 'פתיחת מחזור 2 עם 60 סטודנטיות נוספות.',
          pr: 'יצירת חיבורים אסטרטגיים מול משרדי ממשלה, גופי ביטחון וצבא.'
        }
      },
      {
        time: 'חודשים 8-11',
        title: 'הרחבת צוותים',
        desc: 'מחזור 1 (50 עובדות) הופכות למפתחות מן המניין בחודש 9.',
        pillars: {
          dev: 'קליטת 50 מפתחות חדשות (בוגרות מחזור 1) לצוות הפיתוח.',
          acad: 'סיום המחזור הראשון והכנת התשתית לקליטת מעל 100 תלמידות נוספות.',
          pr: 'קמפיין יח"צ בינלאומי וחשיפת המיזם בכנסים טכנולוגיים גלובליים.'
        }
      },
      {
        time: 'חודשים 12-18',
        title: 'ביסוס טכנולוגי',
        desc: 'מחזור 2 (60 עובדות) הופכות למפתחות מן המניין בחודש 12.',
        pillars: {
          dev: 'קליטת 60 מפתחות נוספות (בוגרות מחזור 2). הגעה למסה קריטית של מפתחות.',
          acad: 'הרחבת מסלולי ההכשרה לנשים ללא רקע קודם בתכנות באמצעות מכינה טכנולוגית.',
          pr: 'מיצוב בינתה כמובילת דעה עולמית (Thought Leader) בתחום ה-AI.'
        }
      },
      {
        time: 'חודשים 18+',
        ...
        pillars: {
          ...
          acad: 'התרחבות מהאקדמיה לאוניברסיטה טכנולוגית מובילה, עם פעילות מלאה.',
          pr: 'ביסוס המותג כסטנדרט עולמי למצוינות וחדשנות בבינה מלאכותית.'
        }
      }
    ],
    ...
    pain_point_1: 'נקודה 1. מקומות העבודה הנפוצים כיום מאתגרים עבור אורח החיים החרדי',
    pain_point_1_desc: 'סביבות עבודה רגילות בהייטק לרוב אינן ערוכות לספק מעטפת תרבותית ורוחנית התואמת את ערכי ההלכה והצניעות.',
    pain_point_2: 'נקודה 2. נשים חרדיות לא תמיד מקבלות שכר הוגן בשל האתגרים של אורח החיים החרדי',
    pain_point_2_desc: 'הצורך בסביבה מותאמת ובשעות גמישות מוביל לא פעם לפשרות על גובה השכר לעומת המקובל בשוק.',
    pain_point_3: 'נקודה 3. הגישה לעולם העבודה מוגבלת לנשות אברכים מטעמים שונים',
    pain_point_3_desc: 'היעדר רשת קשרים בתעשייה, פערי הכשרה מעשיים והצורך לשלב עבודה תובענית עם ניהול משפחה מהווים חסמי כניסה משמעותיים.'
  },
  en: {
    ...
    pillar_1_desc: 'We specialize in developing complex systems for the AI, cyber, and defense industries, while building and training our own independent AI models.',
    ...
    pillar_3_desc: 'Building a strong brand, attracting new potential clients, and establishing development quality and product excellence.',
    team_title: 'The Team',
    team_roles: { founder: 'Founder', ceo: 'CEO', cto: 'CTO', cmo: 'CMO', inst: 'Director of AI', comm: 'Head of Community' },
    team_names: ['Lee OR', 'Yossi Avni', 'Shachar Cohen', 'Hava Siegelmann'],
    ...
    hava_bio: 'An alumna of the Technion and a former visiting professor at MIT, Harvard, and the Weizmann Institute, Professor Hava Siegelmann is a world-renowned pioneer in bio-inspired AI and neural networks. As a Provost Professor at UMass Amherst and Director of the BINDS Lab, she has redefined the boundaries of the field through her groundbreaking work on "hypercomputation"—computing beyond the Turing limit—and her co-invention of the Support Vector Clustering algorithm.While serving as a Program Manager at DARPA (2016–2019), she inaugurated "third-wave AI" through her Lifelong Learning Machines (L2M) program, creating systems capable of evolving in real-time. For her visionary leadership, she was awarded the DARPA Meritorious Public Service Medal, the highest civilian honor bestowed by the Department of Defense. An IEEE and INNS Fellow, she is also a recipient of the INNS Hebb Award and the Obama BRAIN Initiative Award.',
    hava_subtitle: 'Director of AI, UMass Provost-Professor & BINDS Lab Director',
    ...
    biz_3: 'Future Profit Sharing Model',
    biz_3_desc: 'A portion of future profits is designated for reinvestment in the well-being and economic resilience of Binatah employees, aiming to create a stable infrastructure that enables professional and personal growth.',
    ...
    timeline_steps: [
      {
        ...
        desc: 'Recruiting 12 senior developers, establishing LMS infrastructure, and pedagogical planning.',
        pillars: {
          dev: 'Forming initial development team of 12 seniors. Writing first lines of code.',
          acad: 'Building infrastructure for training, meticulous pedagogical planning, and preparing for Cycle 1.',
          pr: 'Establishing the brand and design language, strategic planning of future campaigns.'
        }
      },
      {
        time: 'Month 3',
        title: 'Commencing Activity',
        desc: 'Recruiting 50 students (Cycle 1), launching courses, and starting training.',
        pillars: {
          dev: 'Completion of AMS and infrastructure systems for the academy. Ongoing technical support.',
          acad: 'Opening Cycle 1 with 50 students and beginning intensive training.',
          pr: 'Official brand launch and initial exposure of the unique design identity.'
        }
      },
      {
        time: 'Months 4-6',
        title: 'Growth & Development',
        desc: 'Growth & development, operative integration in code writing and developing core projects.',
        pillars: {
          ...
          pr: 'Showcasing first success stories and building credibility in the tech market.'
        }
      },
      {
        time: 'Month 7',
        title: 'Practical Production',
        desc: 'Recruiting 60 more students (Cycle 2), taking on complex projects.',
        pillars: {
          dev: 'Students join intensive training alongside experienced development teams.',
          acad: 'Opening Cycle 2 with 60 additional students.',
          pr: 'Establishing strategic partnerships with government, defense, and military bodies.'
        }
      },
      {
        time: 'Months 8-11',
        title: 'Team Expansion',
        desc: 'Cycle 1 (50 employees) become full-time developers in Month 9.',
        pillars: {
          dev: 'Onboarding 50 new developers (Cycle 1 graduates) to the development team.',
          acad: 'Successful completion of Cycle 1. Preparing for 100+ more students.',
          pr: 'International PR campaign and showcasing the venture at global tech conferences.'
        }
      },
      {
        time: 'Months 12-18',
        title: 'Technological Consolidation',
        desc: 'Cycle 2 (60 employees) become full-time developers in Month 12.',
        pillars: {
          dev: 'Onboarding 60 additional developers (Cycle 2 graduates). Reaching critical mass.',
          acad: 'Expanding accessibility: opening tracks for women without prior programming knowledge via prep course.',
          pr: 'Positioning Binatah as a global AI thought leader.'
        }
      },
      {
        time: 'Months 18+',
        ...
        pillars: {
          ...
          acad: 'Expanding from an academy to a full-scale university, with training operations at peak capacity.',
          pr: 'Establishing the brand as a global standard for AI excellence and innovation.'
        }
      }
    ],
    ...
    pain_point_1: 'Point 1. Standard workplaces are challenging for the Haredi lifestyle',
    pain_point_1_desc: 'Standard high-tech work environments are often not prepared to provide a cultural and spiritual envelope that matches the values of Halakha and modesty.',
    pain_point_2: 'Point 2. Haredi women do not always receive fair pay due to the challenges of the Haredi lifestyle',
    pain_point_2_desc: 'The need for a tailored environment and flexible hours often leads to compromises on salary levels compared to the market standard.',
    pain_point_3: 'Point 3. Access to the professional world is limited for various reasons',
    pain_point_3_desc: 'The lack of a network in the industry, practical training gaps, and the need to combine demanding work with family management constitute significant entry barriers.'
  }
};
    ...
    <div dir={isRtl ? "rtl" : "ltr"} className="min-h-screen bg-[#0a0a0a] text-gray-200 font-sans selection:bg-gold selection:text-black">
        ...
        <div className="container mx-auto px-6 py-4 flex items-center justify-between relative">
          ...
          >
            <div className="relative group">
              <div className="absolute inset-0 bg-gold/20 blur-md rounded-full scale-110 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              <img 
                src="https://i.postimg.cc/d1KtMDtM/Generated-Image-March-05-2026-5-01AM.jpg" 
                alt="Binatah Logo" 
                className="h-12 w-12 rounded-full border border-gold/20 object-cover relative z-10 grayscale hover:grayscale-0 transition-all duration-500"
          ...
          <div className="flex items-center gap-8">
            <div className="hidden md:flex gap-8">
              ...
              <a 
                href="https://drive.google.com/file/d/1CES5_TIh4Gxf5QcRXsLC2YkECAz5Kd_U/view?usp=sharing"
                target="_blank"
      ...
      <AnimatePresence mode="wait">
        {!showPainPoints ? (
          ...
          >
            {/* Hero Section */}
            <section className="relative min-h-screen flex flex-col items-center justify-center px-6 text-center overflow-hidden pt-24 md:pt-32">
              <motion.div 
                style={{ opacity, scale }}
              ...
              >
                <motion.div
                  ...
                  className="flex justify-center mt-12 md:mt-20 relative"
                >
                  {/* Decorative Rings */}
                  <motion.div 
                    animate={{ rotate: 360 }}
                    transition={{ duration: 20, repeat: Infinity, ease: "linear" }}
                    className="absolute inset-0 m-auto h-[200px] w-[200px] md:h-[340px] md:w-[340px] border border-gold/20 rounded-full border-dashed"
                  />
                  <motion.div 
                    animate={{ rotate: -360 }}
                    transition={{ duration: 30, repeat: Infinity, ease: "linear" }}
                    className="absolute inset-0 m-auto h-[220px] w-[220px] md:h-[380px] md:w-[380px] border border-gold/10 rounded-full"
                  />
                  
                  {/* Main Logo Container */}
                  <div className="relative">
                    <div className="absolute inset-0 bg-gold/20 blur-[80px] rounded-full scale-150 animate-pulse"></div>
                    <div className="relative h-48 w-48 md:h-80 md:w-80 rounded-full overflow-hidden border border-gold/30 shadow-[0_0_50px_rgba(212,175,55,0.2)]">
                      <img 
                        src="https://i.postimg.cc/d1KtMDtM/Generated-Image-March-05-2026-5-01AM.jpg" 
                        alt="Binatah Logo" 
            ...
            <section id="team" className="bg-[#111]/50 py-32">
              <div className="container mx-auto px-6">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-2 gap-8 md:gap-16 mt-16 max-w-4xl mx-auto">
                  {t.team_names.map((name, idx) => {
                    const roles = [t.team_roles.ceo, t.team_roles.cto, t.team_roles.cmo, t.team_roles.inst];
                    const images = [
            ...
            <section id="business" className="container mx-auto px-6 py-32">
              ...
              <div className="flex justify-center">
                <a href="https://drive.google.com/file/d/1CES5_TIh4Gxf5QcRXsLC2YkECAz5Kd_U/view?usp=sharing" target="_blank" rel="noopener noreferrer">
          ...
          <motion.div
            ...
            className="min-h-screen pt-20 pb-10 px-6 container mx-auto max-w-7xl flex flex-col justify-center"
          >
            <button 
              onClick={() => setShowPainPoints(false)}
              className="mb-6 flex items-center gap-2 text-gold hover:text-gold-light transition-colors group self-start"
            >
            ...
            <div className="flex flex-col gap-3 mt-6">
              {[
                { title: t.pain_point_1, desc: t.pain_point_1_desc },
                { title: t.pain_point_2, desc: t.pain_point_2_desc },
                { title: t.pain_point_3, desc: t.pain_point_3_desc }
              ].map((item, idx) => (
                <motion.div
                  key={idx}
                  initial={{ opacity: 0, x: isRtl ? 20 : -20 }}
                  animate={{ opacity: 1, x: 0 }}
                  transition={{ delay: idx * 0.1 }}
                  className={`glass px-5 py-3 rounded-xl ${isRtl ? 'border-r-4' : 'border-l-4'} border-gold group hover:bg-white/5 transition-all flex flex-col gap-1 w-full`}
                >
                  <h3 className="text-base md:text-lg font-bold text-gold">
                    {item.title}
                  </h3>
                  <p className="text-gray-300 text-sm md:text-[16px] leading-relaxed font-light">
                    {item.desc}
                  </p>
                </motion.div>
              ))}
        ...
        {modalContent && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-6">
            ...
            <motion.div 
              ...
              className="relative w-full max-w-4xl glass border-gold/30 rounded-3xl shadow-2xl flex flex-col max-h-[90vh] overflow-hidden"
            >
              <button 
                onClick={() => setModalContent(null)}
